...
import com.galih.rekognisikarakterarab.R
import com.galih.rekognisikarakterarab.databinding.LayoutDialogBaseBinding
...
class BaseDialog private constructor(var context: Context,
    ...
    private lateinit var binding: LayoutDialogBaseBinding
    ...
    private fun initDialog(){
        ...
        binding = LayoutDialogBaseBinding.inflate(LayoutInflater.from(context))

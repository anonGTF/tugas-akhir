package com.galih.rekognisikarakterarab.base.recyclerview
...
import com.galih.rekognisikarakterarab.base.recyclerview.loopingrecyclerview.LoopingLayoutManager


/**
 * Created by Andri Dwi Utomo on 23/6/2022.
 */
class DotsIndicatorDecoration constructor(
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val indicatorStartY = (parent.height) - (8 * density)

        val layoutManager = parent.layoutManager as? LoopingLayoutManager
